...
/*Note NOP=0 b.design*/	NOP, SEC, SEI, MLH, MLL, DIV, MOD, PLX, PLY, PHX,
		...
		static char* opcode_to_string(int opcode);
		...
		std::size_t pending_interrupts() const { return interrupt_queue->size(); }
	...
	protected:
		static char translation_table[81][10];
		static void init_translation_table();
