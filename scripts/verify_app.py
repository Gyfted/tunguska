...
def verify(app, developer_id=False, notarized=False):
    ...
    for name in ("LICENSE", "AUTHORS", "NOTICE.md", "boot.ternobj", "boot-3cc.ternobj",
                 "VISION-NOTICE.md", "vision.ternobj", "vision-digits.bin", "vision-model.json", "vision-weights.bin", "vision-int8-weights.bin", "explorer.ternobj", "breach.ternobj", "matvec.metal"):
